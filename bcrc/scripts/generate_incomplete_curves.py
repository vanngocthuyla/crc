...
pickle.dump(expt.to_dict(), open(os.path.join(args.out_dir, 'bdrc_sim_unnorm_complete.pickle'), "wb"))
expt.to_csv(os.path.join(args.out_dir, 'bdrc_sim_unnorm_complete.csv'))

pickle.dump(expt_incomplete.to_dict(), open(os.path.join(args.out_dir, 'bdrc_sim_unnorm_incomplete.pickle'), "wb"))
expt_incomplete.to_csv(os.path.join(args.out_dir, 'bdrc_sim_unnorm_incomplete.csv'))
...
pickle.dump(expt_1.to_dict(), open(os.path.join(args.out_dir, 'bdrc_sim_norm_complete.pickle'), "wb"))
expt_1.to_csv(os.path.join(args.out_dir, 'bdrc_sim_norm_complete.csv'))

pickle.dump(expt_incomplete_1.to_dict(), open(os.path.join(args.out_dir, 'bdrc_sim_norm_incomplete.pickle'), "wb"))
expt_incomplete_1.to_csv(os.path.join(args.out_dir, 'bdrc_sim_norm_incomplete.csv'))
